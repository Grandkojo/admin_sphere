...
<div class="container-fluid">
    <div class="add-buttons">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#upload-course-material">
            <i class="fa fa-plus me-2" aria-hidden="true"></i>Assignment
        </button>
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="text" id="search" name="search" class="form-control"
                    placeholder="Search assignment here" value="{{ request('search') }}" autocomplete="on">
            </div>
            <div id="loader"
            ...
            <table class="table table-bordered ">
                ...
                <tbody>
                    ...
                    @if ($assignments->isNotEmpty())
                        @foreach ($assgnments as $assignment)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $assignment->course_id }}</td>
                                <td>{{ $assignment->assignments_instruction }}</td>
                                <td>{{ $assignment->file_name }}
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            {{-- <li><a id="assignmentDetails" class="dropdown-item"
                                                    href="{{ route('admin.students.details', $assignment->id) }}">Details</a>
                                            </li> --}}
                                            <li><a class="dropdown-item"
                                                    href="{{ route('teacher.course-material.edit', $assignment->id) }}">Edit</a>
                                            </li>
                                            <li><a id="deleteassignment" onclick="deleteMaterial(event)"
                                                    class="dropdown-item"
                                                    href="{{ route('teacher.course-material.destroy', $assignment->id) }}">Delete</a>
                                            </li>
                                        </ul>

                                        <form id="delete-form-{{ $assignment->id }}"
                                            action="{{ route('teacher.course-material.destroy', $assignment->id) }}"
                    ...
                    @else
                        <tr>
                            <td colspan="5" class="text-center">No assignment uploaded.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('teacher.upload-course-material') }}" method="post" id="upload-form"
                    ...
                    <div class="form-group">
                        <label for="file_upload"><b>Assignment Material*</b></label>
